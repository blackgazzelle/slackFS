...
def main():
    ...
    fhh.file_decode.argtypes = [c_char_p, c_void_p, c_int, c_int, c_int, c_int, c_int, c_int]
    ...
    if os.path.getsize(data_file) == 0:
        if len(sys.argv) < 3:
            print("Please provide csv headers as a comma separated list no spaces")
            exit()
